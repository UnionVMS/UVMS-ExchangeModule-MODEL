...
public class ExchangeModuleRequestMapper {
    ...
    public static String createReceiveAssetResponse(String response, String username, String guidOfOriginalMessage, String responseCode) throws ExchangeModelMarshallException {
        ReceiveAssetResponse receiveAssetResponse = new ReceiveAssetResponse();
        receiveAssetResponse.setResponse(response);
        receiveAssetResponse.setUsername(username);
        receiveAssetResponse.setMethod(RECEIVE_ASSET_RESPONSE);
        receiveAssetResponse.setSenderOrReceiver(FLUX_VESSEL_PLUGIN);
        receiveAssetResponse.setDate(new Date());
        receiveAssetResponse.setResponseCode(responseCode);
        receiveAssetResponse.setGuidOfOriginalMessage(guidOfOriginalMessage);

        return JAXBMarshaller.marshallJaxBObjectToString(receiveAssetResponse);
    }
