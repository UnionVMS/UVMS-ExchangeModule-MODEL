 ...
 * 2017-01-26T14:37:27.702+01:00
 * Generated source version: 2.7.6
 * 
 */
@WebServiceClient(name = "ExchangeModuleService", 
                  wsdlLocation = "file:/c:/uvms-3.0.1-C3PO/models/ExchangeModule/src/main/resources/contract/ExchangeModuleService.wsdl",
...
public class ExchangeModuleService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/c:/uvms-3.0.1-C3PO/models/ExchangeModule/src/main/resources/contract/ExchangeModuleService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ExchangeModuleService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/c:/uvms-3.0.1-C3PO/models/ExchangeModule/src/main/resources/contract/ExchangeModuleService.wsdl");
        }
        WSDL_LOCATION = url;
    }
