 ...
 * 2016-09-30T12:32:20.119+02:00
 * Generated source version: 2.7.6
 * 
 */
@WebServiceClient(name = "ExchangeModuleService", 
                  wsdlLocation = "file:/C:/uvms-2.1.0-jessamine-boffin/models/ExchangeModule/src/main/resources/contract/ExchangeModuleService.wsdl",
...
public class ExchangeModuleService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/uvms-2.1.0-jessamine-boffin/models/ExchangeModule/src/main/resources/contract/ExchangeModuleService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ExchangeModuleService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/uvms-2.1.0-jessamine-boffin/models/ExchangeModule/src/main/resources/contract/ExchangeModuleService.wsdl");
        }
        WSDL_LOCATION = url;
    }
