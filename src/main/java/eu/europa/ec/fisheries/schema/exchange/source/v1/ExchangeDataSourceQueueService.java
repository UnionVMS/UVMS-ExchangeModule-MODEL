 ...
 * 2016-07-08T12:19:14.210+02:00
 * Generated source version: 2.7.6
 * 
 */
@WebServiceClient(name = "ExchangeDataSourceQueueService", 
                  wsdlLocation = "file:/C:/uvms-git-release/models/ExchangeModule/src/main/resources/contract/ExchangeDataSourceService.wsdl",
...
public class ExchangeDataSourceQueueService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/uvms-git-release/models/ExchangeModule/src/main/resources/contract/ExchangeDataSourceService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ExchangeDataSourceQueueService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/uvms-git-release/models/ExchangeModule/src/main/resources/contract/ExchangeDataSourceService.wsdl");
        }
        WSDL_LOCATION = url;
    }
