 ...
 * 2016-09-30T12:32:21.459+02:00
 * Generated source version: 2.7.6
 * 
 */
@WebServiceClient(name = "ExchangeDataSourceQueueService", 
                  wsdlLocation = "file:/C:/uvms-2.1.0-jessamine-boffin/models/ExchangeModule/src/main/resources/contract/ExchangeDataSourceService.wsdl",
...
public class ExchangeDataSourceQueueService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/uvms-2.1.0-jessamine-boffin/models/ExchangeModule/src/main/resources/contract/ExchangeDataSourceService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ExchangeDataSourceQueueService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/uvms-2.1.0-jessamine-boffin/models/ExchangeModule/src/main/resources/contract/ExchangeDataSourceService.wsdl");
        }
        WSDL_LOCATION = url;
    }
