 ...
 * 2016-09-30T12:32:22.442+02:00
 * Generated source version: 2.7.6
 * 
 */
@WebServiceClient(name = "ExchangeRegistryService", 
                  wsdlLocation = "file:/C:/uvms-2.1.0-jessamine-boffin/models/ExchangeModule/src/main/resources/contract/ExchangeRegistryService.wsdl",
...
public class ExchangeRegistryService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/uvms-2.1.0-jessamine-boffin/models/ExchangeModule/src/main/resources/contract/ExchangeRegistryService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ExchangeRegistryService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/uvms-2.1.0-jessamine-boffin/models/ExchangeModule/src/main/resources/contract/ExchangeRegistryService.wsdl");
        }
        WSDL_LOCATION = url;
    }
