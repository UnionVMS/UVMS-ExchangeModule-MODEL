 ...
 * 2017-01-05T09:06:13.175+01:00
 * Generated source version: 2.7.6
 * 
 */
@WebServiceClient(name = "ExchangeRegistryService", 
                  wsdlLocation = "file:/C:/uvms-3.0.0-boba-fett/models/ExchangeModule/src/main/resources/contract/ExchangeRegistryService.wsdl",
...
public class ExchangeRegistryService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/uvms-3.0.0-boba-fett/models/ExchangeModule/src/main/resources/contract/ExchangeRegistryService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ExchangeRegistryService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/uvms-3.0.0-boba-fett/models/ExchangeModule/src/main/resources/contract/ExchangeRegistryService.wsdl");
        }
        WSDL_LOCATION = url;
    }
